...
let Me = JSQMessagesAvatarImageFactory().avatarImage(withUserInitials: "ME", backgroundColor: UIColor.jsq_messageBubbleGreen(), textColor: UIColor.white, font: UIFont.systemFont(ofSize: 12))
...
func getAvatar(name: String) -> JSQMessagesAvatarImage{
    return JSQMessagesAvatarImageFactory().avatarImage(withUserInitials: name, backgroundColor: UIColor.gray, textColor: UIColor.white, font: UIFont.systemFont(ofSize: 12))
}
extension String {
...
func getMyTextAvatar(name : String) {
    let array = name.components(separatedBy: "")
    JSQMessagesAvatarImageFactory().avatarImage(withUserInitials: array[0][0] + array[1][0], backgroundColor: UIColor.jsq_messageBubbleGreen(), textColor: UIColor.white, font: UIFont.systemFont(ofSize: 12))
...
//    conversation = [message2,message3, message4, message5, audioMessage]
//    return conversation
//}

//func makeNormalConversation() -> [JSQMessage] {
//    conversation = [message6, message7, message8, message9, audioMessage]
//    return conversation
//}
